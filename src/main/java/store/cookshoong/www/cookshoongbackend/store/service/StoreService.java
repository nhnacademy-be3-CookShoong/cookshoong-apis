...
public class StoreService {
    ...
    public Page<StoreListResponseDto> getStoreList(Long accountId, Pageable pageable) {
        return storeRepository.getStoresPage(accountId, pageable);
    }
     ...
     */
    public void saveStore(StoreRegisterRequestDto registerRequestDto) {
        ...
        BankType bankType = bankTypeRepository.findById("SHIN").orElseThrow(() -> new IllegalArgumentException("존재하지 않는 은행타입입니다."));
